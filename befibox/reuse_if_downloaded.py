...
def reproducir_notificacion(filename = "notificacion.mp3"):
...
def download_and_play_youtube_audio(url):
    ...
    if not os.path.exists(limpiar_texto(realfilename)):
    ...
    counter = 4
    if 'Reggaeton' in genre:
        reproducir_notificacion("es-reggaeton.mp3")
        time.sleep(1.2)
    elif 'jazz' in genre:
        reproducir_notificacion("es-jazz.mp3")
        time.sleep(1.2)
    elif 'pop' in genre:
        reproducir_notificacion("es-pop.mp3")
        time.sleep(1.2)
    elif 'Rock' in genre:
        reproducir_notificacion("es-rock.mp3")
        time.sleep(1.2)
    else:
        reproducir_notificacion("no-genero.mp3")
        time.sleep(1.2)
